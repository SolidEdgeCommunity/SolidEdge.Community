...
namespace EmbedResources
{
    class Program
    {
        ...
        {
            Console.WriteLine("EmbedResources Version: {0}", Assembly.GetExecutingAssembly().GetName().Version);
            Console.WriteLine("usage: EmbedResources.exe <project directory> <assembly full path>");
        }
